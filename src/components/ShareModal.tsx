          ...
          {supportsNativeShare ? (
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 8 }}>
              ...
              <a href="https://www.instagram.com/" target="_blank" rel="noopener noreferrer"
                onClick={() => { navigator.clipboard.writeText(shareText); showToast('Caption copied — paste in Instagram'); }}
              ...
              <button onClick={() => { navigator.clipboard.writeText(shareText); showToast('Copied!'); }}
                style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 8, padding: '12px', background: 'var(--surface)', color: 'var(--text)', border: '1px solid var(--border)', borderRadius: 10, cursor: 'pointer', fontFamily: 'var(--sans)', fontSize: 12, fontWeight: 500 }}>
                Copy text
              </button>
            </div>
          )}
